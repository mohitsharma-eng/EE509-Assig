...
public class Queue 
{
	...
	{
		batchMeans.offer((totalBatchTime/2500));
		totalBatchTime=0;
	}
	public void calcLossRatio()
	{
		lossRatios.offer((packetsDroppedPerBatch/2500));
		packetsDroppedPerBatch = 0;
	}
	...
	{
		System.out.println("-----------------"+name+"--------------");
		System.out.println("Batch means per 1000 transmitted packets:");
		System.out.println("===========================================");
		while(batchMeans.size()!=0)
			System.out.println(batchMeans.poll());
		System.out.println("===========================================");
		
		System.out.println("Lost packet ratio per 1000 offered packets:");
		System.out.println("===========================================");
